        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., 5572926"
                  pattern="^[0-9]{7}$"
                  title="7-digit license plate number"
                  maxLength={7}
                  required
                />
              </div>
            ...
            <Button 
              ...
              className="w-full bg-white text-black border border-gray-300 hover:bg-gray-50 rounded-full px-6 py-3 font-medium"
            >
              {loading ? (
                <>
